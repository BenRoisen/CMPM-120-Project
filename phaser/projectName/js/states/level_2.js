...
var loadLevel_2 = function(game, player, platforms, enemies, orePots, exit, ores, specialEntities, decorations, background) {
	...
	var map = game.add.tilemap('level02');
	...
	map.createFromObjects('Collisions', 10, 'CollisionBox', 0, true, true, platforms);
	...
	console.log(potSpawners.length);
	...
	for (k = 0; k < exits.length; k++) {
		...
		var door = exit.create(element.x - 50, element.y - 45, 'doorAtlas', 'Mineshaft1');
